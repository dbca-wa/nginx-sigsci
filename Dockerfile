...
FROM nginx:1.30.4@sha256:5cf90903deda2c5981b8ad05e7617ac010e389f0dde0ac83487c02c509281de6
...
RUN apt-get -y install sigsci-agent=4.80.1 nginx-module-fastly-nxs=1.30.4\* \
